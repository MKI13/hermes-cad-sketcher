...
- **Snap-Inference und Achsensperre** — Linien, Flächen und Körper stellen Endpunkt-, Mittelpunkt-, Zentrum-, Kanten- und Flächen-Fangpunkte bereit; der Viewport zeigt deutsche Snap-Labels am Cursor, farbige temporäre Achsenlinien für X/Y/Z und sperrt Achsen per Pfeiltasten, während Shift die aktuelle Inference hält.
